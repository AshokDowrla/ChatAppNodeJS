...
const ProfileMenu = () => {
  ...
  const user_img = `https://res.cloudinary.com/${CLOUDINARY_CLOUDNAME}/image/upload/c_scale,w_100/v${user?.avatar?.version}/${user?.avatar?.public_id}.${user?.avatar?.format}`;
