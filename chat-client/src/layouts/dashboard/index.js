...
const DashboardLayout = () => {
  ...
  useEffect(() => {
    if (isLoggedIn) {
      ...
      socket.on("update_messages", (data) => {
        // console.log(data, "update_messages");
        if (current_conversation?.id === data.room_id) {
          dispatch(FetchCurrentMessages({ messages: data.filteredMsgs }));
        }
      });
  ...
  }, [isLoggedIn, conversations, user_id, dispatch, current_conversation]);
