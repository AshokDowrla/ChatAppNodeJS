...
const TextMsg = ({ el, menu, action }) => {
  ...
  return (
    <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
      ...
      {menu && <MessageOption action={action} id={el.id} />}
    </Stack>
  );
};
const MediaMsg = ({ el, menu, action }) => {
  const theme = useTheme();
  return (
    <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
      <Box
