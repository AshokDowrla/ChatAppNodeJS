...
const CallDialog = ({ open, handleClose }) => {
  ...
  const appID = 1072833719;
  const server = "wss://webliveroom1072833719-api.coolzcloud.com/ws";
  ...
  }, [roomID,userID, userName,audioStreamID,incoming,zg,token,videoStreamID,handleDisconnect  ]);
